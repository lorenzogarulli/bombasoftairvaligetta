  ...
  if (disarmcode == '*')
  {
    ...
    if (keycount == 4)
    {
      if (entered[0] == password[0] && entered[1] == password[1] && entered[2] == password[2] && entered[3] == password[3])
      {
        ...
        lcd.print("ben fatto!");
        keycount = 0;
        digitalWrite(greenled, LOW); // quando la bomba viene disinnescata rimane 
        delay(15000);                //acceso il led verde
        lcd.clear();
        lcd.setCursor(0, 1);
...
void timer()
{
  ...
  if (Hours <= 0)
  {
    if ( Minutes < 0 )
    {
      ...
      while (Minutes < 0)
      {
        digitalWrite(redled, LOW); //quando la bomba esplode attiva il led rosso
        tone(9, 7000, 100);
        //delay(100);
        //digitalWrite(redled, HIGH);
        //tone(9, 7000, 100);
        ...
        //tone(9, 7000, 100);
        //delay(100);
        digitalWrite(greenled, HIGH);    // e spegne il led verde
        //tone(9, 7000, 100);
        //delay(100);
      }
    }
  ...
  if (Seconds < 1)
  {
    ...
    if (Seconds > 0)
    {
      ...
      if (currentMillis - secMillis > interval)
      {
        ...
        Seconds --;
        //digitalWrite(yellowled, HIGT);
        //delay(10);
        digitalWrite(greenled, LOW); // quando la bomba viene impostata si attiva
        //delay(100);                //il led verde
        }
      }
